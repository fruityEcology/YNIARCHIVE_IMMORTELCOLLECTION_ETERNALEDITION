...
//	DrawGraph(0, 0, ground_after_image, TRUE);
 ...
 //    	}
	...
	if (coins < 0) {
		...
		DrawString(mouse_x + 16, mouse_y, "★coini:", GetColor(255, 102, 153));  //
		DrawString(mouse_x + 86, mouse_y, std::to_string(coins).c_str(), GetColor(255, 102, 153));  //
	...
	if (coins >= 0) {
		...
		DrawString(mouse_x + 86, mouse_y, std::to_string(coins).c_str(), GetColor(255, 102, 15));  //
